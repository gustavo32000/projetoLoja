...
/* O cliente irá enviar os dados no formato json. porém nós precisamos dos dados no formato php para atualizar em banco de dados.
...
if(!empty($data->senha) && !empty($data->id)){
    ...
    if($usuario->alterarSenha()){
        ...
        header("HTTP/1.0 400");
        echo json_encode(array("mensagem"=>"Não foi possível alterar a senha do usuário."));
    }
}
