...
/* Função listar para selecionar todos os usuários cadastrados no banco de dados. 
...
public function login (){
    /* Consulta para realizar o login. Estamos usando o nome de usuario e a senha.
    O valor para ambos os campos foi passado como parâmetro */
    $query = "select * from usuario where nomeusuario=? and senha=?";

    /* Abaixo há uma ligação com os parâmetros da consulta(bind-ligação | Param -> parâmetros)
    as posições estão relacionadas aos pontos de interrogação.
